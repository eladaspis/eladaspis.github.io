...
<div style="display: flex; gap: 1rem; align-items: flex-start; justify-content: center; margin: 2rem 0;">
  <figure style="flex: 1; min-width: 200px; margin: 0;">
    <img src="/images/vqvae_with_ste.svg" alt="Computation graph with straight-through estimator" style="display: block; max-height: 480px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px;" />
  ...
  <figure style="flex: 1; min-width: 200px; margin: 0;">
    <img src="/images/vqvae_no_ste.svg" alt="Computation graph without straight-through estimator" style="display: block; max-height: 480px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px;" />
